...
def desenhar():
    ...
    # viewport superior esquerdo
    glViewport(10, 410, 380, 380)
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
    ...
    # viewport inferior esquerdo
    glViewport(10, 10, 380, 380)
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
    ...
    # viewport superior direito
    glViewport(410, 410, 380, 380)
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
    ...
    # viewport inferior direito
    glViewport(410, 10, 380, 380)
    glMatrixMode(GL_PROJECTION)
    glLoadIdentity()
